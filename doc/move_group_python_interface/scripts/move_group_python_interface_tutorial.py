...
def all_close(goal, actual, tolerance):
 ...
 #   print (goal)
 #   print (actual)
    goal = [goal.pose.position.x, goal.pose.position.y, goal.pose.position.z, goal.pose.orientation.x, goal.pose.orientation.y, goal.pose.orientation.z, goal.pose.orientation.w]
    actual = [actual.pose.position.x, actual.pose.position.y, actual.pose.position.z, actual.pose.orientation.x, actual.pose.orientation.y, actual.pose.orientation.z, actual.pose.orientation.w]
 #   print(goal)
 #   print(actual)
    return all_close(goal, actual, tolerance)
...
def main():
  try:
    ...
    tutorial.group.set_max_velocity_scaling_factor(0.1)

    pose = tutorial.group.get_current_pose()
    ...
    # print "============ Press `Enter` to execute a movement using a pose goal ..."
    # raw_input()
    # tutorial.plan_to_pose_goal2()

    
    print "============ Press `Enter` to initialize upright path constraints (press ctrl-d to exit) ..."
    raw_input()
    tutorial.init_upright_path_constraints(pose)

    
    print "============ Press `Enter` to enable upright path constraints (press ctrl-d to exit) ..."
    raw_input()
    ...
    print "============ Press `Enter` to disable upright path constraints (press ctrl-d to exit) ..."
    raw_input()
